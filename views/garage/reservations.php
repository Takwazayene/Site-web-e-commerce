...
$reservations = $garageController->getReservationsByUser(Config::getUserSession()->getId());
        ...
        <div class="row" style="margin-top: 50px">
            <table cellspacing="0" class="shop_table cart">
                ...
                <tr>
                    ...
                    <th class="product-quantity">Mechanicien</th>
                        ...
                        <tr style="background: <?php echo $color?>" class="cart_item">
                            ...
                            <td class="product-thumbnail">
                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail"
                                                                   src="<?php echo curPageURL()?>/assets/front/images/product-thumb-2.jpg"></a>
                            </td>
                            ...
                            <td class="product-quantity">
                                <div class="quantity buttons_added">
	                                <?php
	                                  $user = $userController->findUserById($reservation["id_technicien"]);
