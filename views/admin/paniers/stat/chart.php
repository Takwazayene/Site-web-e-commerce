...
<?php
   ...
   // $strQuery = "SELECT nom, qte FROM produit ORDER BY qte DESC LIMIT 10";
        $strQuery = "SELECT categorie_id, SUM(qte) as quantite FROM produit GROUP BY categorie_id ORDER BY SUM(qte) DESC LIMIT 10";
    ...
    if ($result) {
        ...
        $arrData = array(
            "chart" => array(
              "caption" => "organisation des catégories par quantite total decroissante",
