            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    <div class="profile_pic">
                        <img src="<?php echo curPageURL() ?>/assets/back/images/img.jpg" alt="..."
                    ...
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a><i class="fa fa-desktop"></i> Utilisateurs <span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/user/index.php?role=user">Liste Clients</a></li>
                                      <li><a><i class="fa fa-bar-chart-o"></i>Statistiques<span
                                            class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/statistic/reservation.php">Reservations</a></li>
                                </ul>
                            </li>
                                </ul>
                            </li>
                             ...
                             <li><a><i class="fa fa-desktop"></i> Produits <span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/produits/index.php">Ajouter Constructeurs</a></li>
                                 <li><a href="<?php echo curPageURL() ?>/views/admin/produits/index.php">Liste Constructeurs</a></li>
                             ...
                             <li><a><i class="fa fa-desktop"></i> Paniers et commandes <span
                                ...
                                <ul class="nav child_menu">
                                    ...
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/paniers/afficherCommande.php">Liste Commandes</a></li>
                                     <li><a href="<?php echo curPageURL() ?>/views/admin/paniers/stat/chart.php">Stat</a></li>
                                          <li><a href="<?php echo curPageURL() ?>/views/admin/paniers/statProduit.php">Stat</a></li>
                            ...
                            <li><a><i class="fa fa-edit"></i> Garage <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="<?php echo curPageURL() ?>/views/admin/garage/index.php">Liste</a></li>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown"
                               aria-expanded="false">
                                <img src="<?php echo curPageURL() ?>/assets/back/images/img.jpg" alt="">John Doe
...
<script src="<?php echo curPageURL() ?>/assets/back/vendors/raphael/raphael.min.js"></script>
<script src="<?php echo curPageURL() ?>/assets/back/vendors/morris.js/morris.min.js"></script>
